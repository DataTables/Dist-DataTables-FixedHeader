...
e[a])})};e("th");e("td")},_unsize:function(b){var a=this.dom[b].floating;a&&("footer"===b||"header"===b&&!this.s.autoWidth)&&d("th, td",a).css("width","")},_horizontal:function(b,a){var e=this.dom[b],c=this.s.position,d=this.s.scrollLeft;e.floating&&d[b]!==a&&(e.floating.css("left",c.left-a),d[b]=a)},_modeChange:function(b,a,e){var c=this.dom[a],d=this.s.position;if("in-place"===b){if(c.placeholder&&(c.placeholder.remove(),c.placeholder=null),this._unsize(a),c.host.append("header"===a?this.dom.thead:
...
this.dom.tfoot.length))a=!c.visible||a+c.windowHeight>=c.tfootBottom+this.c.footerOffset?"in-place":c.windowHeight+a>c.tbodyTop+c.tfootHeight+this.c.footerOffset?"in":"above",(b||a!==this.s.footerMode)&&this._modeChange(a,"footer",b),this._horizontal("footer",e)}});g.version="3.0.1-dev";g.defaults={header:!0,footer:!1,headerOffset:0,footerOffset:0};d.fn.dataTable.FixedHeader=g;d.fn.DataTable.FixedHeader=g;d(document).on("init.dt.dtb",function(b,a){if("dt"===b.namespace){var d=a.oInit.fixedHeader||
f.defaults.fixedHeader;d&&!a._fixedHeader&&new g(a,d)}});f.Api.register("fixedHeader()",function(){});f.Api.register("fixedHeader.adjust()",function(){return this.iterator("table",function(b){(b=b._fixedHeader)&&b.update()})});f.Api.register("fixedHeader.enable()",function(b){return this.iterator("table",function(a){(a=a._fixedHeader)&&a.enable(void 0!==b?b:!0)})});f.Api.register("fixedHeader.disable()",function(){return this.iterator("table",function(b){(b=b._fixedHeader)&&b.enable(!1)})});f.Api.register("fixedHeader.headerOffset()",
function(b){return void 0===b?0!==this.context.length?this.context[0]._fixedHeader.c.headerOffset:void 0:this.iterator("table",function(a){(a=a._fixedHeader)&&a.headerOffset(b)})});f.Api.register("fixedHeader.footerOffset()",function(b){return void 0===b?0!==this.context.length?this.context[0]._fixedHeader.c.footerOffset:void 0:this.iterator("table",function(a){(a=a._fixedHeader)&&a.footerOffset(b)})});return g});
